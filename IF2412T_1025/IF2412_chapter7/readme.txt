...
※上記のCSVファイルの文字コードはUTF-8になっているので，エクセルで開くと文章が文字化けしている場合があります．これはPythonでファイルを読み込む場合のデフォルトの文字コードがUTF-8であるためです．CSVファイルをメモ帳で開くなどUTF-8でみると文字化けなしで文章を見ることが可能です．
...
　Copyright (C) 2024　Takumi Sugiura